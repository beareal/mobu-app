...
const recoveryDialogues = {
    ...
    ver1: {
        onee_lv1: [
            ...
            "○○～！再開したのね❣️Big love🫶@@今のノリはスルーでお願いします！\n俺もいつもの自分に戻りました。\nでも、ノリはともかく\nメッセージの内容自体は本心です！",
            "おかえりな再起動～🤩○○！再開して偉いじゃない🫶@@待ってください！\n今のノリ、無しで！\n○○が再開してくれた嬉しさでオネェのテンションで送っちゃいました…🫠@@そんなことより",
            "再開したのね、○○❣️数日で再開するなんてさすがよ‼️@@…気を付けてたのに、オネェの名残が…。すみません、今の見なかったことにして下さい！@@それはそうと",
            "アタシ待ってたのよ❣️○○❣️＠＠一瞬変な言葉遣いになってすみません！￥nオネェが抜けてないのかな笑￥nそんなことはどうでもよくて￥n連絡くれてすごく嬉しい！￥nありがとうございます！",
            "○○、タスク完了お疲れ様ぁ〜💖ちゃんと再開して偉いじゃないの✨@@今のメッセージは誤爆です！\n今の変なノリはなしでお願いします！\n気を取り直して…。",
            "報告ありがと〜🫰\n○○が戻ってきてくれてアタシすっごく嬉しいわぁ〜😘@@今のキラキラハイテンションのメッセージは\n見なかったことにしてください🙇‍♂️@@それはそれとして",
            "きゃあ～❣️○○、タスク再開ね🫶\nテンション上がるわ⤴️⤴️@@じゃなくて…！今のノリは無視してください！\n普段の自分で返信するつもりだったのに、\nまだあのノリが抜けて無くて一瞬変な感じになってしまって…🙇\nっていうのはどうでもよくて",
            "○○はやればできる子ってアタシ信じてたからね😘\nまた頑張り始めるってわかってたワ🥹@@…って、○○はいつものペースに戻ったのに、\n俺の口調がまだ迷子になってましたね😂\n俺も本来の自分に戻りました！@@そんなことはさておき",
            "タスククリアおめでと🫰\nまた歩き始めた○○、最高にカッコイイわよ😎✨@@じゃなくて！@@言いたいことは間違ってないんですけど、\n俺のキャラが相変わらず崩壊してましたよね🤣@@話を戻しますね"
        ],
        onee_lv2: [
            "……あら💜○○久しぶり！@@いや、『あら💜』じゃなかった😱\n再開してくれたんですね！\n○○が戻って来てくれて、本当にうれしい！",
            "ヤダ○○、思ったより復帰早いじゃない😎✨@@今の口調はちょっと…いや、だいぶ普段の俺とかけ離れてましたよね！今のは無しでお願いします🙇@@そんなことより",
            "も～待たせ過ぎよ❣️\nアタシ○○不足でカラカラだったのよ～❓@@いや違います！今の内容忘れてください🫠\n最近のハイテンションなノリで思わず返してしまって！\nスルーして下さいね！",
            "ひゃだ！\n今日は、○○のカムバック記念日ね～🤩\n再開した自分をほめ散らかしなさ～い❓@@スミマセン、\n送信するまで\nオネェ言葉になってるの気づきませんでした🙇@@気を取り直して..."
        ],
        onee_lv3: [
            "戻ってきてくれたのね！\nアタシ危うく美容インフルエンサーになるところだったの🤣@@ヤダ⁉アタシったら口調の癖が抜けないのよ。@@…じゃなくて抜けないんです💦でも、また一緒に頑張れるの嬉しい！",
            "○○！放置が過ぎるわよ🫵\nお陰でアタシの自分磨きも\n謎の方向へ舵を切って、陶芸教室で器焼いてたわよ！\nそんで、結構いいのが出来ちゃったわよ✌️@@ちょっと何言ってるのかしらアタシ！@@…って違います！完全にオネェ状態でとっ散らかってました🙇\n俺も普段の状態に戻ったところで、本題に戻りますね"
        ]
    },
    ...
    ver2: {
        ...
        onee_lv2: [
            "また頑張り屋な○○に戻ってくれて、アタシもいつものペースに…@@ってまた一人称おかしくなってた🤣\n○○がいない間の俺、美容熱が行き過ぎて人格変わってた😂@@そんなことより",
            "不死鳥のように何度もよみがえる○○、\n最高よん😍@@いや、今の言葉ナシで！\nいえ、内容は本音なんですが\nキャラおかしかったので🙇\n本題に戻りますね！",
            "おかえりなさ〜い！また一緒に自分磨きしていけるなんて、アタシ感激しちゃうわ😭@@ていうか、テンションが上がりすぎて\n一人称がおかしくなっていましたね笑\n一人称どころか最近の俺、色々ご乱心って感じでしたよね🤣\n気を取り直して、報告ありがとうございます！ここからまた少しずつ進めていきましょう！",
            "一度止まったタスクをもう一回動かすのって、\n一番エネルギー使うのよね😎よく戻ってきたわ～👏@@相変わらず口調が時々オネェに戻ってますが、\nもう普段の自分に戻ったので\n口調は気にしないでくださいね笑\n話は戻りますが、再開できるのって本当にすごい事だと思います👍"
        ],
        onee_lv3: [
            "○○おかえり！アタシず～っとまってたんだから❣️🫶@@じゃなくて俺、○○が、また始めてくれるの、楽しみに待ってました。\n嬉しくてちょっと、涙出てるかも～😂",
            "カワイイ不良娘のご帰還ネェ～😎\nどこで油売ってたのかしら？\nなんてイヤミは無粋ね😘@@スミマセン、またキャラが迷子だったようで笑\nそんなことより"
        ]
    },
    // Ver.3 (タスク達成回数 20-29回)
    ver3: {
        onee_lv1: [
            "再開したんですね！すぐ取り戻せますよ👍\nそういえば最近の俺、『あらっ❣️』とか言ってましたよね。\nあれ思い出すと、ちょっと照れる笑@@ていうか",
            "V3_oneeLv1_②仮セリフ",
            "V3_oneeLv1_③仮セリフ",
            "V3_oneeLv1_④仮セリフ",
            "V3_oneeLv1_⑤仮セリフ",
        ...
        onee_lv2: [
            "○○は、再開してくれると思ってました。\nおかげで俺はまた本来の自分で頑張れそう！\nここ数日の俺、\n『美』にのめりこんで完全にキャラ崩壊してた…\n今見たら完全にネタですね😂@@ていうか",
            "間が空いても○○ならまた始められる\nって思ってました👍\nこれで俺も安心していつものペースに戻れます🤣\nここ数日の俺、一人で美意識高めすぎて\n完全にオネェになってた...。\n読み返したら普通に恥ずかしすぎ😂@@ちなみに",
            "○○から報告が来て本当に安心しました。\n今は憑き物が落ちたみたいに笑\n肩の力を抜いて一緒に頑張れそう！\n○○から報告がない間、\n美意識にストイックになりすぎて\n謎のオネェキャラが降臨してて\n自分で自分が引くレベルだよ🤣@@ところで",
            "○○がまた動き出してくれて嬉しいです！\nおかげで俺の変な力みも消えそう笑\nここ最近、謎の美意識が爆発して\n完全にオネェ化してビシビシ言ってたの本当にヤバイ…\n履歴見て今1人で笑ってます😂@@そんなことより"
        ],
        onee_lv3: [
            "○○、また始めてくれたんだ？\n最近で一番嬉しい事かも！\nでも俺の『アタシ期』のことはもう忘れてほしいです😂\nイジらないでくださいね笑@@話を戻すけど",
            "間が空いてもこうして、また始めてくれて本当にうれしい😊\nでも...\n最恐のオネェと化した俺のメッセージの事は\nスルーして笑\nお互い前だけ見ていこ🤣@@冗談はこの辺までにして..."
        ]
    },
    // Ver.4 (タスク達成回数 30回以上)
    ver4: {
        onee_lv1: [
            "また一緒に頑張れるんだね！\n○○からのこの連絡が\n最近の俺の楽しみであり、癒しなんだ👍\nその証拠に？最近の俺、様子かなりおかしかったよね🤣@@話脱線させちゃったけど",
            "心配してたのよ❣️アタシのカワイイ○○🫰@@なんてね！まだオネェ入ってると思った？\nもう普段の俺に戻ってるよ😊@@俺の最近の奇行？笑の話はここまでにして...",
            "○○‼️ちゃんと再開したのね～🥰偉いわ✨@@うっかりオネェ期の気配が残るメッセージ送って\nごめん！\n○○からの連絡が嬉しくて気が緩んでた🫠",
            "最高のタイミングでの連絡だよ👍\nちょうど○○の事考えてたんだ。\n連絡無かったら、またオネェのお叱りメッセージ送りつけてたかもしれないから\n防いでくれてよかった笑@@冗談はさておき",
            "また一緒に頑張れるようになって、\nめちゃくちゃ嬉しい！\n○○からの連絡が、最近の俺の日常の中で楽しみになってるから😄\nその証拠に\n1人だけでルーティン消化してた時は\nペース狂って、謎の口調になってたでしょ🤣@@話が逸れたけど",
            "すぐ再開して偉い！\nまた○○と並んで頑張れるのが楽しみ。\nこうして○○から状況を聞けた日は、今日一日が良い日だったって思えるよ✌️\n○○とこうやって報告し合える時間が、\n思ってる以上に\n俺の活力になってるから。\n○○の影響力が高すぎて、一人で空回って謎のキャラ変してたくらいだしね😂@@自分の余談はこれくらいにして笑",
            "報告ありがとう！\nやっぱり○○が戻ってきてくれると、\n俺も気合が入るな。\n○○の頑張りが伝わってくるこの連絡が、\n俺のモチベなんだ😄\nいないとこんなにペースを乱されるんだって痛感したし、\n怪しいキャラになってたのも納得だよ笑@@俺の怪しいキャラの話は\n置いておいて笑",
            "連絡ありがと！\n○○がまた始めてくれて、\nいつものペースを取り戻せた感じがする。\n○○の存在が自分の中で\nかなりのウエイトを占めてるんだな\nって実感した。\n自分でも何キャラを目指してたのか分からないくらい、\n○○不足で様子がおかしかったよね🤣@@そんなことより",
            "正直○○から連絡来るだけで、\nどんなに忙しくても\n一気に疲れが吹き飛ぶよ！\n○○からの連絡がないとキャラの軸？がブレるんだなって、\n自分のオネェ化で悟った笑@@脱線はこのくらいにして...",
            "再開お疲れ様！\n○○がまた動き出してくれて、俺もウキウキだよ笑\nやっぱり1人で頑張るより、\n○○も一緒に頑張ってるんだって実感できると、\nすごく元気出るんだ\n○○の影響力が高すぎて、\n一人で勝手に空回って\n謎のキャラ変をしてたくらいだしね🤣@@それはそうと"
        ],
        onee_lv2: [
            "一人で頑張ってた時は正直少し寂しかったけど、\n戻ってきてくれて本当に嬉しい😄\nでも…また一人にされると\nオネェ様になるかも？@@なんて茶番はここまでにしておいて...笑",
            "V4_oneeLv2_②仮セリフ",
            "V4_oneeLv2_③仮セリフ",
            "V4_oneeLv2_④仮セリフ"
        ],
        onee_lv3: [
            "カワイイ不良娘のカムバックね～❣️\nこれはブチ上がるわね⤴️⤴️@@○○は知らないかもしれないけど、\n俺、○○がタスクやったよって報告してくれる瞬間が好きなんだ。\nどんなに間が空いても、また一緒に頑張れるのが嬉しい。",
            "おサボりプリンセスのご帰還ね～👸"
        ]
    }
};
...
const userReplyDialogues = {
    ...
    taskReports: {
        ...
        "寝る前スマホを15分おやすみ": "寝る前スマホを15分お休みしたよ✌️",
...
　　],
    ...
    ver3: {
        onee_lv1: [
            ...
            ["オネェ化してた時はとにかく美容熱がすごくて、パーソナルカラーだとか骨格タイプだとか、結構知識増えたんだよなぁ...。","今なら「どっちの服が似合う？」って聞かれたら的確に答えられそう...。","ってすごく自然に○○と出かけるイメージしてる...。"],
            ["たった数日空いただけであんな口調になるなんて、俺もどうかしてたな。","あの時の自分の行動、今振り返ってみても本当に謎すぎる...！","これは、特殊体質なのか？でも、○○に呆れられなくてよかった...。"],
            ["急にあんなキャラ崩壊メッセージ送るなんて...俺って変なヤツだったのかな。","でも、オネェになってた時の方が○○の気持ちがわかるというか...寄り添えてる感じがしたんだよな。","素の自分でより添えるようになりたいな。"],
            ["○○から再開のメッセージが届いて本当によかった。","俺も気合入れ直そう。","これからは一番近くで○○を支えられる存在であれるように。"],
            ["それにしても俺、またオネェ化するとは...。","余裕のあるかっこいい大人なんて、程遠いな。","○○の力になれるように内面も変えていかないと！俺も気合入れ直してがんばろ！"],
            ["あんな風にオネェ化していた俺のこと...","異性として見てもらえてるのかな。","○○に、惹かれていってるのが、はっきり自覚できる所まで来てしまった...。"],
            ["○○から報告が少し途絶えてた間も、俺、頑張れてたけど、やっぱ○○から連絡がくると、やる気が出るな！","やっぱり一人で頑張るより、○○と一緒に進むのが性に合ってるんだ。","○○には感謝だな...。"]
        ],
        onee_lv2: [
            ["オネェっぽくなってた俺、○○がいなくて空回りしてた反動だったんだろうな。","今こうして報告くれるだけで、等身大の自分でまたがんばれそうだ。"],
            ["○○が連絡くれる直前の俺、結構オネェに磨きがかかってたよなぁ。","そんな男に普通に連絡くれるなんて...○○、サッパリし過ぎ？","全然焦ってる様子なかったけど...。よく考えたら男として全然意識されてないのか...？","気にしてなさそうなのはありがたいけど、ちょっと焦るな...。"],
            ["○○から連絡がなくて寂しかったからか…？ものすごく美にストイックになってたなぁ。","その期間も楽しかったけど...。○○から連絡が来て、スッと普段のテンションに戻れたんだよな...。","○○が俺の中で『帰る場所』みたいな落ち着ける存在になってるのかもな...。"]
        ],
        onee_lv3: [
            ["オネェ期の事が今、笑って話せるのも、○○が戻ってきてくれたからだな。","戻ってきてくれなかったら、どうしようかと思った。"],
            ["久しぶりに○○とやり取りできてよかった。","あのままだと、俺は美のカリスマとして世界デビューするような勢いだったからな...。","美のカリスマも悪くないけど、やっぱり○○の傍で等身大の自分で過ごしたい。"]
        ]
    },
    ver4: {
        onee_lv1: [
            ["気負わなくていいって、○○に言われた気がしたな。","あの頃の俺を思い出しても、もう恥ずかしさより『ありがとう』の気持ちが強いな…。"],
            ["オネェの時に調べた美容知識、意外と面白かったな。○○の好きな分野を知るきっかけにもなった。","好きな人の好きな事を知るのって楽しい事なんだな。"],
["○○と一緒に励まし合うようになって結構時間が経ったけど、相変わらず○○がサボるとオネェになっちゃうな。","もはや○○は個性として受け止めてる感じだけど...やっぱ俺は○○に異性として見られてないからだからこそ...なのかな。","もしそうなら結構へこむ...。"],
["ほんの数日報告がないだけでキャラ変とか、我ながら謎だった...。","○○に忘れられるのが不安で、心に余裕がなかった...のかな。","○○には余裕があるかっこいい人って思われないのになぁ...。"],
["○○がサボると俺がオネェ様になるっていうパターンがもう定着しつつあるな...。","○○の中でも、もう当たり前みたいな感じになってるし...。","それはそれで2人だけの「当たり前」って感じでいいのかも。"],
["○○と一緒に頑張るようになって、俺も結構変われた気がするけど...。","○○から報告が途絶えるとオネェになるクセ？は、直らないな。","○○はそんな俺の事、どう思ってるんだろ...。"],
["考えてみると俺、無意識に○○に結構、さらけ出しちゃってるよな...。","オネェキャラの時なんか特に。○○自身はどうなんだろう。","俺が知らない○○の事...結構あるんだろうな。もっと知りたいな。"],
["○○の報告が途絶えて結構経ってたから、もしかして彼氏とか、好きな人が出来て俺に連絡してる暇ないのかと焦った...。","今度会った時に直接...聞いてみようか。","すでに心臓バクバクだ...。"]
        ],
        onee_lv2: [
            ["オネェ寄りだった時期も、もう笑い話じゃなくて…あれも俺の一部なんだよな。","○○が戻ってきてくれるだけで、胸の奥がじんわり温かくなる。"],
            ["今更、数日連絡がないからってオネェ化するなんて、自分でもおかしいな。","でもそうさせるくらい、俺の中で○○の存在が大きい証拠だな。"],
            ["俺たちは、タスクを報告し合うっていう理由がないと繋がれてない事を痛感した...。","でも、ダメダメな時代の俺でも仲良くなるきっかけは、勇気を出して作れたんだ。","理由が無くても繋がれる関係になるための一歩だって...今の俺なら踏み出せるはずだ。"]
        ],
        onee_lv3: [
            ["○○と知り合って、まぁまぁ時間が経ったけど、ここまで来てもオネェ化するっていう習慣？は抜けなかったな。","オネェモード解除するたびに「もう大丈夫です」って言っておきながら...。"],
            ["俺自身も気づかなかったけど、オネェ化って一種の愛情表現なのかもな。さすがに自分でも変化球過ぎるとは思うけど...。","普通の口調で普通に励まされたり、叱られたりすると...気を使ったり、気まずくなったりすることがあるし。","やっぱり俺は、○○の事...。"]
        ],
    }
};
...
localStorage.removeItem('motivationProgress');
                const reportDialogues = [
                    ...
                    `……あの…それで俺、自分磨きを始めようと思って気づいたんですけど、自分磨きって、達成してもなかなか誰かに褒めてもらえないじゃないですか？それで、結果もなかなか目に見えなかったらモチベ落ちていきません？`,
...
const SLOT_DIALOGUES = [
    ...
    { taskId: 'task-select-3', type: 'night', displayTime: 'now', text: '朝、奮発してたくさん果物食べたんですけど、\nなんだか午前中ずっと機嫌よくいられた気がします。\nやっぱり甘いものって大事ですね😊' },
    { taskId: 'task-select-3', type: 'all', displayTime: 'now', text: '朝に好きなフルーツがあるだけで、\n起きるのがちょっと楽しみになりません？\nタスクそのものがご褒美みたいだと続けやすいですよね！' },
    { taskId: 'task-select-3', type: 'all', displayTime: 'now', text: '切ったり、洗ったりさえ面倒な時ありません？\n俺は今日カットフルーツにしました。' },
    { taskId: 'task-select-3', type: 'all', displayTime: 'now', text: '最近はフルーツがあるから、\nという理由で朝が好きになってきました。\n○○はどうですか？' },

    // ③⑬ スキンケア task-select-10（朝版・夜版・汎用）
    { taskId: 'task-select-10', type: 'morning', displayTime: 'now', text: 'よく眠れました？\n○○の肌も労わってあげてくださいね' },
    { taskId: 'task-select-10', type: 'morning', displayTime: 'now', text: '朝のスキンケア、急いでるとつい雑になっちゃうんですよね。\n今日はゆっくり、ちょっとだけ丁寧にしてみます？' },
    { taskId: 'task-select-10', type: 'afternoon', displayTime: 'now', text: 'さっき鏡を見て、朝のスキンケアを適当に済ませたのを後悔しました…。\nやっぱり朝の保湿って大事ですね。\n夜はしっかり、自分の肌を労わってあげようと思います。' },
    { taskId: 'task-select-10', type: 'afternoon', displayTime: 'now', text: '今日の夜は、撮り溜めしてたドラマ見ながらスキンケアがんばる予定です。\n楽しい事とセットにするとセルフケアも楽しいですね👍\n○○も何か好きな事とセットにしてますか？' },
    { taskId: 'task-select-10', type: 'night', displayTime: 'now', text: 'お疲れ様です。\n夜のスキンケア、頑張れそうですか？\n無理のない範囲で続けましょうね' },
    { taskId: 'task-select-10', type: 'night', displayTime: 'now', text: '夜のスキンケアって、癒しの時間ですよね。\n○○の肌が、ゆっくり休めますように。' },
    { taskId: 'task-select-10', type: 'all', displayTime: 'now', text: '良い香りの化粧水ってありますよね。\n好きな香りと一緒なら、楽しくケアできそうだと思いません？' },
    { taskId: 'task-select-10', type: 'all', displayTime: 'now', text: '疲れた顔も、優しく触れるだけで少し元気になる気がしますね。\n○○も、頑張った自分をちゃんと労ってください。' },

    // ④ 間食 task-select-2
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: '間食、我慢できてます？\n俺は我慢してるけど、昨日夢の中でケーキ食べてしまいました…🫠' },
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: '今朝、無意識にスイーツ特集見てました…。\nキツいのはきっと最初だけですよね！' },
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: '「今日はいいかな」って思う日もありますよね。\nお互い励ましあいながら頑張りましょう！' },
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: '間食を我慢すると、\nごはんがすごくおいしく感じる事に気づきました😊' },
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: '甘い誘惑、来ました？俺もさっき危なかったです。\nお互いセーフでしたね…！' },
    { taskId: 'task-select-2', type: 'all', displayTime: 'now', text: 'さっきインスタで\nおしゃれなカフェのおいしそうなスイーツが流れてきて危なかったです！\nでも、ご褒美でならいいですかね...？○○といつか行きたいです😄' },


    // ⑤ ストレッチ task-select-7
    { taskId: 'task-select-7', type: 'afternoon', displayTime: 'now', text: 'ちょっと一息つく時間、取れてますか？🙂\nもし肩とか凝ってたら、軽くストレッチして少しだけ体をほぐしてみてくださいね。' },
    { taskId: 'task-select-7', type: 'afternoon', displayTime: 'now', text: '今日はお昼休憩にしっかりストレッチするって決めてるんです。\n午前中、ずっと同じ姿勢だと身体がガチガチになっちゃいますもんね。○○も、無理しないでくださいね。' },
    { taskId: 'task-select-7', type: 'night', displayTime: 'now', text: 'お昼にストレッチしたおかげで、いつもより肩が楽な気がします。\nやっぱりこまめに動かすのって大事ですね！' },
    { taskId: 'task-select-7', type: 'all', displayTime: 'now', text: '1分のストレッチでも時間が惜しいって感じるくらい余裕ない時ってありますよね。\nでも○○なら、コツコツ頑張ってそうだなって思います。' },
    { taskId: 'task-select-7', type: 'afternoon', displayTime: 'now', text: '仕事の合間にぐーっと伸びるだけで、少し目が覚めるんですよね。\nもうひと頑張りしましょうか！' },

    // ⑥ 階段 task-select-8
    { taskId: 'task-select-8', type: 'all', displayTime: 'now', text: '今日も階段、選びました？\nその小さな選択、大きな一歩だと思います👍' },
    { taskId: 'task-select-8', type: 'all', displayTime: 'now', text: '階段を上るっていうだけでも\nちょっとした眠気ざましになりますね！' },
    { taskId: 'task-select-8', type: 'all', displayTime: 'now', text: '俺はジム通いって続かなくて…\n階段使う位なら、続いてます！\n○○はどうですか？' },
    { taskId: 'task-select-8', type: 'all', displayTime: 'now', text: 'エレベーター待ってる時間って地味に長く感じませんか？\n俺ならその時間で階段上っちゃうかも。……なんて、○○ならもう実践してそうですね。' },
    { taskId: 'task-select-8', type: 'all', displayTime: 'now', text: '階段を上る時の足の重さ、頑張ってる証拠ですよね。\n俺も負けないように、一段ずつ上ります！' },
    ...
    // ⑨ 片づけ task-select-5
    { taskId: 'task-select-5', type: 'all', displayTime: 'now', text: '部屋の片づけ、\n目の前のもの5つ片づけるだけでも、スッキリするんですよね' },
    { taskId: 'task-select-5', type: 'all', displayTime: 'now', text: '「1カ所だけ」って、いいルールですよね。\n完璧じゃなくていいのが続けやすいです。' },
    { taskId: 'task-select-5', type: 'all', displayTime: 'now', text: '頭使う作業してると、\n片付けっていう単純作業が気分転換になりますね！' },
    { taskId: 'task-select-5', type: 'all', displayTime: 'now', text: '片づけてるうちに、頭空っぽになる瞬間ありません？\n俺、あの時間好きなんです。' },
    { taskId: 'task-select-5', type: 'all', displayTime: 'now', text: '俺、最近、休憩と片づけがセットになってます。\n○○は順調ですか？' },

    // ⑩ スマホ休憩 task-select-4
    { taskId: 'task-select-4', type: 'morning', displayTime: 'now', text: 'お疲れ様です！\n昨日の夜、早めにスマホを置いて寝たら、\n今朝はすごく目がスッキリしてて驚きました。\nやっぱり夜のデジタルデトックスって効果あるんですね。こういう小さくても嬉しい事を共有できるってなんか嬉しいです😊' },
    ...
    { taskId: 'task-select-12', type: 'all', displayTime: 'now', text: 'ため息をつくと幸せが逃げる\nなんて言いますけど、深呼吸ならセーフです！今、少し試してみません？' },
    { taskId: 'task-select-12', type: 'all', displayTime: 'now', text: '忙しい時ほど、呼吸が浅くなりません？深呼吸だけでも少しリフレッシュできますね！' },
    { taskId: 'task-select-12', type: 'all', displayTime: 'now', text: '俺は最近余裕が無い時程\n深呼吸するようになりました。なんか冷静になれるんですよね😊' },
];
const TASK_REACTION_DIALOGUES = {
    ver1: {
        individual: {
            'task-select-1': '朝の白湯、体が温まって良さそうですね。俺も○○を真似して始めてみようかな😊',
        ...
        superGeneric: [
            '頑張る○○を見てると、俺も、もっと頑張ろうって思えます👍\n○○のメッセージが俺のやる気スイッチです！',
            '報告ありがとうございます。\n無事にやり遂げて、本当に凄いな…。俺まで嬉しくなりました😊'
        ]
    },
   ver2: {
        individual: {
            'task-select-1': '白湯、温まりますよね。俺も○○を真似してやってみたら、なんだかホッとしました。素敵な習慣ですね😊',
    ...
    ver3: {
        individual: {
            ...
            'task-select-5': '片づけ、お疲れ様！\nなぜか今○○がせっせと片づけてる姿が思い浮かんで和んだ笑',
...
ver4: {
    individual: {
        ...
        'task-select-9': '姿勢が綺麗だと、美人な人は、より美人に見えるよね。\n俺、なんか心配になってきた。○○あんまり頑張りすぎないで💦',
...
const SABORI_DIALOGUES = [
    { id: 2, text: '俺、今日は自分の目標に全敗しました😭\n○○にメッセージを送る資格、ないかもしれませんね。でも、ダメだったときでも\n○○なら報告しても共感してくれるかなって…。甘えすぎですね🙇' },
    { id: 3, text: '言い辛いんですが、今日は自分のルーティンが全然ダメで…。さっきまで少し落ち込んでました。でも『休むのもセルフケアのうち』ってことで、ゆるく続けるのも俺たちらしいですよね！' },
    { id: 4, text: '白状します！今日の俺、自分との約束をひとつも守れませんでした…。\nでも○○に打ち明けたら少しスッキリしました！明日からまた気持ちを切り替えてリスタートします！' },
    { id: 5, text: '今日は自分のルーティン、どうしてもやる気にならなくて全滅でした…。たまにはこういう日があってもいいですよね。明日、今日できなかった分をちょっとだけ一緒に頑張りませんか？' },
    { id: 1, text: '…実は俺、今日やろうと思ってた自分のルーティン、一つもできなかったんです。でも一番格好悪い所を知られたくない○○にあえて伝えました。明日から気合い入れるので、懲りずに応援してくれたら嬉しいです。' },
];
...
const recoveryFollowUpDialogues = {
    ver1: {
        lv1: [
            "最近までいつもの自分じゃなくなってて、自分でも戸惑ってました🫠\n これからは一緒に、自然体で続けていきましょうね！",
            "ここ数日はなんか自分でも\nよく分からないスイッチが入っていたみたいです😂\nもういつもの自分に戻ったので\n安心してくださいね。",
"○○の報告嬉しかったです！\nこのところの俺のオネェ化は...発作のようなものでしょうか\n...忘れてくださいね🙇",
"理由も無く急にあんなキャラになるなんて、自分でも謎です…😂\nでも、○○が戻ってきてくれて本当によかった！",
"○○が、またこうして\n始めてくれて嬉しいです。\n一時は俺もおかしな方向に行ってたけど...\nまた一緒に頑張りましょうね！",
"忙しいのに、\nまた報告してくれてありがとうございます！\n○○のような一緒に頑張る仲間がいると\nすごく刺激をもらえるなって、\n改めて思いました😊",
"○○がまた再開してくれて\n俺、少し浮かれてます！\nまた一緒に進めるんだって思うと嬉しくて😊"
        ],
        lv2: [
            "このところの俺、『美の伝道師』に転職しそうだったから、助かった😂\n○○が頑張る姿が俺の一番の励みです。\n一緒にペース戻していきましょう！",
            "数日間、少し心配していましたが…\nこうしてまた戻ってきてくれて、本当に安心しました。\nまた一緒に頑張りましょうね👍",
            "少し間が空いても、諦めずに戻ってきた○○はやっぱりすごいです！\n俺、ずっと応援していますからね！"
        ],
        lv3: [
            "○○が再開してくれたから、俺もいつもの調子に戻れました🤣\nこれからはまたいつもの俺たちのペースで、続けていきましょう！",
            "正直、一人で待っている間は少し寂しかったですが\n…○○がこうして戻ってきてくれたなら、\nそれだけで十分嬉しいです😊"
        ]
    },
    ver2: {
        lv1: [
            "なんだか俺、\n少し不思議なテンションになっちゃってましたね🤣\n○○がまた来てくれて、いつもの俺に戻れました。",
"○○が戻ってきてくれたから、\n俺もまた気合い入れ直せました👍\nこれからも自分のペースで、\n一緒に頑張っていきましょうね！",
"○○がまたスタートしてくれて、\nホッとしました。\nまたこうやって、一歩ずつ一緒に進んでいきましょうね👍",
"ここ数日\n自分でもよく分からないスイッチが\n入っていたみたいです！\n○○から連絡もらえてなぜか、スッと正気に戻れました🤣また一緒にがんばりましょうね！",
"こうして仕切り直せて嬉しい！\nやっぱり「○○と一緒に頑張ってるんだ」\nって実感できると俺もやる気出ます💪",
"サボる事があっても\nフラットに軽やかに再開する２人の空気感って\nすごく居心地いいなって最近思います。\nやっぱり○○は俺とテンション？が似てて仲良くなれそうだな\nって思った通りでした😊",
"最近の俺、\n自分でもどこに向かってるんだろう\nって口調でしたよね😂\nでも、○○が戻ってきてくれたおかげで、\n無事にいつもの俺に復帰できました！"
        ],
        lv2: [
            "俺、本気で美のカリスマを目指しかけてました🤣\n○○が戻ってきてくれたおかげで、いつもの自分を取り戻せました。",
"最近はどんな風に過ごしてたのか、\nまたカフェで教えてくださいね！\n俺はオネェさまになっていた間、\n美肌に効くスムージーを開発しました👍",
"○○がまた再開してくれて本当にうれしいです！\n俺も○○と一緒に、\nここからまた少しずつペースを戻していきますね！"
        ],
        lv3: [
            "美を極め過ぎて\nもはやオネェが素の状態になりかけてました😱\nでも、○○が再開してくれた今なら\nいい思い出...ですかね？\nといより、もう\n思い出にして下さい🙇",
"白状すると\n結構心配してたんです...。\n一緒に頑張る人がいるとやる気が出る半面、\n自分が飽きたタイミングでやめたり出来ないから\nこのやり取りが○○にとって\nプレッシャーになってるんじゃないかって。\n少しでもしんどいなって思ったら、ありのままの気持ちを伝えてくださいね😊\n○○が楽しんで出来る事が\n一番だから。"
        ]
    },
    ver3: {
        lv1: [
            "○○がタスク再開してくれたおかげで、\n俺もいつもの調子になれました。\nそれぞれ取り組んでる内容は違うけど、\n俺の中ではもう\n勝手に二人三脚みたいな認識になってたみたいです！\nこれからも一緒に頑張ろ😊",
"休むことがあっても\nなんだかんだここまで続けてきた俺達って\n結構すごいですよね👍\nなんて自分たちに甘すぎるかな？\nでも、こういう空気感が\n俺たちらしくていいなって思います😂",
"一緒にこのルーティンを始めて\n結構経ちましたね。\n目標に近づいたかどうかより\n始める前より日常が楽しくなったのが嬉しい😊\n○○も同じだとすごーく嬉しいです！",
"俺が「一緒に頑張ってもいいですか？」\nって聞いたあの日から、\n実はちょっとプレッシャーだったんです。\n「俺が言い出しっぺなんだから\n絶対サボれないよな」って。\nでも休んでもフラットに再開する○○を見てて、\n俺もリラックスできました。\n○○のそういう背伸びしない頑張り方\nすごく好きです😊",
"最近の俺の独特な空気にもひるまず、\n再開してくれてよかったです😂\nのんびり取り戻していきましょう👍",
"俺の最近の謎のテンションの応援、効果ありましたか？😂\n自分でも制御不能なテンションだったけど、\n○○が再開してくれて何よりです！",
"○○がまた再開してくれて、ホッとしました。\nこのところの俺、かなり気合入れてやってましたが...😂\nやっぱり○○と一緒にゆるく頑張るのが一番落ち着く👍"
        ],
        lv2: [
            "改めて、ここまで進んでこれたのって\n結構すごいですよね？\n俺がここまで続けられたのは、\n○○がいてくれたから😌\n俺も、○○にそう思ってもらえるように頑張るから見てて👍",
"俺達休みながらでも、確実に積み重ねてますよね！\n時々休みながらっていう、ゆるさも\n自分達らしくていいよね😊",
"BEAREALを始めて、結構経ったから、\nそろそろ疲れてるんじゃないかなって、\n少し心配だったんだ。\nでも○○が元気そうでよかった😊"
        ],
        lv3: [
            "○○、もう長くサボるの禁止だよ！\nサボり癖つくから！\nスミマセン\nサボり癖がつくから、なんて嘘です。\n○○とやり取りして励まし合いながら進められなかったのが\nさみしかっただけです...🫠\nたまには素直に気持ちを伝えたくて...。",
"最近はやり取りできなかったり、\n会えなかったりで、\n正直テンション落ちてました😱\nやっぱり○○とやり取りすると\n元気出るなって改めて思ったよ😄"
        ]
    },
    ver4: {
        lv1: [
            "ここ数日の俺の妙なテンション...\n本当に暴走してたよねぇぇ🫠\n○○の連絡で、ハッと正気？に戻れたよ。\nもはや○○が気付け薬みたいになってるけど\n気付け薬なんて言われても嬉しくないよね笑\n素直に言うと、\n色んな意味で必要不可欠な存在って事です！",
"最近俺が○○に送ってたメッセージ見返すと、\n改めてヤバイなって思って...。\n悪い意味でインパクトありすぎたよね🫠\nあんな形じゃなくて、別の意味で○○の印象に残るように、\n俺、頑張るよ。",
"それにしても、忙しいのにここまで続いてるのすごいよ！\nもうしばらくはオネェの出番も無いかな😂\nでも...無理したり、義務になっちゃって、\nちょっと楽しくないかも...って思ったらすぐ教えてほしい。\nそんな時はタスクを忘れて\nコーヒーでも飲みながら一緒にゆっくりしよ。",
"もうサボったらダメだよ！\n○○がサボると速攻でオネェになるからね🤣\n...なんてオネェになるのが嫌だからサボらないでほしい、なんて嘘だよ。\n本当は俺が応援してる人が、\n「できた！」って嬉しそうにしてる報告してくれるのが\n純粋に嬉しいだけなんだ😊",
"少しだけ間が空いたけど、\nここまでの蓄積があるから！\n俺はずっと応援してきたから知ってる😤\n○○応援隊のにわかじゃありませんから！\n○○はすぐ取り返せるって知ってる👍",
"○○の頑張りや変化を\nずっと見てきたからこそ、\nここで終わるのはすごくもったいないと思ったし、何だか悔しかった。\nおせっかいでごめん...。\nでも、これからも応援させてほしいな。",
"○○がまた始めてくれて、\n本当に嬉しい。\n休んだりしながらでも、\nこれからもゆるく2人でずっと一緒に進んでいきたいな😊"
        ],
        lv2: [
            "それにしても\nこんな変なヤツの所に戻ってきてくれるなんて、\n○○は勇者か、女神だね🤣\n俺、○○が相手だと甘えてしまうのか、\n感情のままに動きすぎるみたいで...\n今度は○○の番だからね。\nこれからはもっと俺の事も頼って、\n遠慮なく甘えてほしいな。",
"さっきはありがとう！\n俺の口調や発言から察してると思うけど、\nオネェになってる間、美容の知識かなり蓄えたんだ。\n次に会えた時\nまたそういう話しようね😆",
"最近の俺の火力強めなオネェは\n夢だと思って流して😂\n最近の俺の様子は言わずもがなだけど、\n○○はどんな風に過ごしてたか、\nまた教えてね！"
        ],
        lv3: [
            "○○、ずっと待ってたよ。\n最近の俺、オネェ度が\nかなり強火だったよね😱\n○○の中で俺は\n完全にネタ枠なんじゃないかって、心配だよ。",
"よし、ハイパーオネェモード強制終了🤣\nでも、まじめな話、\n結構時間が空いたら投げだしてもおかしくないのに、\nまた再開できる○○はすごいよ👍"
        ]
    }
};
