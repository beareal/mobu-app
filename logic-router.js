...
ver4: {
    ...
    superGeneric: [
        ...
        'お疲れ様。これからもお互い励まし合って頑張ろうね👍でも、改めて出会った頃に比べてこんなに仲良くなれるなんて夢みたいに思える。正直○○に憧れてたから。いきなり変な事言ってごめん💦でも本心だよ。'
    ]
}
};
// ===============================================
...
const recoveryFollowUpDialogues = {
    ver1: {
        ...
        lv3: [
            "○○が再開してくれたから、俺もいつもの調子に戻れました。ありがとう。これからはまたいつもの俺たちのペースで、続けていきましょう！",
