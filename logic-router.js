...
const cinematicDialogues = {
    ver2: {
        onee_lv1: [
            ...
            ["また連絡をくれて本当によかった。数日間だけだけど、オネェさんになっていた間、美容の知識も増えたし、○○と共有の話題が出来てそれはそれで良かったのかもな...。"],
            ...
            ["直接会えたわけじゃないけど、画面越しでも数日ぶりに○○とやり取りできてうれしい。オネェの間は、いつも以上にケアを頑張ってたけど、ちょっとやりすぎてたかも。俺も自分のペースで仕切り直そう。"]
        ],
        onee_lv2: [
