...
const TASK_REACTION_DIALOGUES = {
    ver1: {
        ...
        superGeneric: [
            'お疲れ様です！頑張る○○を見てると、俺も、もっと頑張ろうって思えます👍',
   ...
   ver2: {
        ...
        superGeneric: [
            ...
            'お疲れ様！今日もこうして頑張りを共有できて嬉しいな。…明日も、応援させてください✊'
        ]
    },
    ver3: {
        individual: {
...
const moodQuestionDialogues = {
    ver1: {
        morning: [
            "何かを新しく始めるのって張り切っちゃいますよね😊でも無理はしないでくださいね！今日の○○はどんな感じですか？",
            "何か新しい習慣ってワクワクしませんか？俺は今すごくワクワクしてます😊○○はどうですか？"
        ],
        afternoon: [
    ...
    ver2: {
        morning: [
            "少しずつですけど、新しく始めた習慣が馴染んできた気がしますね！なんか俺、楽しくなってきました✨○○はどうですか？",
            "タスクこなすのも、慣れてきました？慣れてきた頃に疲れが出やすいんですよね😮‍💨○○は大丈夫？"
        ],
        afternoon: [
            "今日は、バタバタしてたんですけど、○○から通知が来ると、やっぱりホッとしますね😌○○は今どんな気分ですか？",
            "お疲れ様です。この時間って何となくちょっと一息つきたくなりますよね😮‍💨○○は今、どんな気分で過ごしてますか？"
        ],
        night: [
            "1つでも「できた」があると、どんな日でもちょっと気分上がりますよね～😊○○は、今どんな気分ですか？",
            "夜静かになると、ちょっと先の事、考える事ないですか？俺、○○と一緒に頑張り始めて明日が来るのが楽しみになってきたんです🙂○○は今、どんな気持ちで過ごしてますか？"
        ]
    },
    ver3: {
        morning: [
            "そろそろ本格的に習慣化してきたかも？😄でも慣れてきた頃に疲れが出やすいんですよね。○○は元気？",
