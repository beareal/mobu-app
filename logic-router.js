...
const recoveryDialogues = {
    ...
    ver1: {
        onee_lv1: [
            "○○！自分磨き再開したのね💖…って、また口調がっ💦　も、もう『アタシ』じゃなくて『俺』だから！おかえり😊ほんとに嬉しい。",
            "V1_oneeLv1_②仮セリフ",
            "V1_oneeLv1_③仮セリフ",
            "V1_oneeLv1_④仮セリフ",
            "V1_oneeLv1_⑤仮セリフ",
        ...
        onee_lv2: [
            "……あら、○○久しぶり💜…いや、『あら💜』じゃなかった💦再開してくれたんですね！○○が戻って来てくれて、本当にうれしい！",
            "V1_oneeLv2_②仮セリフ",
            "V1_oneeLv2_③仮セリフ",
            "V1_oneeLv2_④仮セリフ"
        ],
        onee_lv3: [
            "戻ってきてくれたのね！アタシ危うく美容インフルエンサーになるところだったの💦ハッ！？口調の癖が抜けないのよね。…じゃなくて抜けないんです💦でも、また一緒に頑張れるの嬉しい！",
            "V1_oneeLv3_②仮セリフ"
        ]
    },
    ...
    ver2: {
        ...
        onee_lv2: [
            "また頑張り屋な○○に戻ってくれて、アタシもいつものペースに…ってまた一人称おかしくなってた💦○○がいない間の俺、美容熱が行き過ぎて人格変わってた😂",
            "V2_oneeLv2_②仮セリフ",
            "V2_oneeLv2_③仮セリフ",
            "V2_oneeLv2_④仮セリフ"
        ],
        onee_lv3: [
            "おかえり！アタシ…じゃなくて俺、嬉しくてちょっと、涙出てるかも～😂",
            "V2_oneeLv3_②仮セリフ"
        ]
    },
    ...
    ver3: {
        onee_lv1: [
            "おっ、再開したんですね！きっとすぐ取り戻せますよ！そういえば前の俺、『あらっ！』とか言ってましたよね。あれ思い出すと、ちょっと照れる🫠",
            "V3_oneeLv1_②仮セリフ",
            "V3_oneeLv1_③仮セリフ",
            "V3_oneeLv1_④仮セリフ",
            "V3_oneeLv1_⑤仮セリフ",
    ...
    ver4: {
        ...
        onee_lv2: [
            "一人で頑張ってた時は正直少し寂しかった💦戻ってきてくれて本当に嬉しいよ！でも…また一人にされるとオネェ様になるかも？なんて、冗談だよ！",
            "V4_oneeLv2_②仮セリフ",
            "V4_oneeLv2_③仮セリフ",
            "V4_oneeLv2_④仮セリフ"
        ],
        onee_lv3: [
            "○○は知らないかもしれないけど、俺、○○がタスクやったよって報告してくれる瞬間が好きなんだ。どんなに間が空いても、また一緒に頑張れるのが嬉しい。",
            "V4_oneeLv3_②仮セリフ"
        ]
    }
};
...
const cinematicDialogues = {
    ver2: {
        onee_lv1: [
            ...
            ["Ver.2のオネェLv1のシネマ仮セリフ-2"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-3"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-4"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-5"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-6"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-7"],
            ["Ver.2のオネェLv1のシネマ仮セリフ-8"]
        ],
        onee_lv2: [
            ["無理に笑ってるけど、ちょっと恥ずかしい。","オネェになった後でも普通に接してくれるって、○○はホント優しいな…。"],
            ["Ver.2のオネェLv2のシネマ仮セリフ-2"],
            ["Ver.2のオネェLv2のシネマ仮セリフ-3"]
        ],
        onee_lv3: [
            ["○○が再開してくれたのが、嬉しくて正直泣きそうだ…何とか笑いでごまかしたけど。","○○は、俺がこんなに喜んでるの気づいてるのかな…？"],
            ["Ver.2のオネェLv3のシネマ仮セリフ-2"]
        ]
    },
    ver3: {
        onee_lv1: [
...
const moodStampReplyData = {
    ...
    ver4: {
        ...
        '元気': ['○○の元気な顔、勝手に思い浮かぶよ。\n……今の○○見たら、きっと俺、言葉より先に笑ってると思う。', '○○から元気なスタンプが届くと、\nこっちまでパッと明るい気分になれるよ！\n\nそのパワー、いつも密かに分けてもらってる😁'],
...
let shouldGlowBackButton = localStorage.getItem('showBackButtonGlow') === 'true';
