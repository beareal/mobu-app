...
const recoveryDialogues = {
    ...
    ver2: {
        ...
        onee_lv2: [
            ...
            "不死鳥のように何度もよみがえる○○、最高よん😍@@いや、今の言葉ナシで！\nいえ、内容は本音なんですが、キャラおかしかったので🙇\n本題に戻りますね！",
            "V2_oneeLv2_③仮セリフ",
            "V2_oneeLv2_④仮セリフ"
        ],
        onee_lv3: [
    ...
    ver3: {
        ...
        onee_lv2: [
            "○○は、戻ってきてくれると思ってました。おかげで俺はまた本来の自分で頑張れそう！……ここ数日の俺、『美』にのめりこんでました…今見たら完全にネタですね😂",
            "V3_oneeLv2_②仮セリフ",
            "V3_oneeLv2_③仮セリフ",
            "V3_oneeLv2_④仮セリフ"
        ],
