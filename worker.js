...
const CLEARED_MESSAGES = {
  1: "おめでとう🐻 頑張り抜いた君は本当に素敵。少し休んだら、また新しい種を一緒に撒こうね🌷",
  2: "ひと休みできてる？🐾 君がくれた「できた」の記憶、大切に預かっているよ。いつでも待ってるね🐻",
  3: "クリアの余韻を楽しんでね🌈 次はどんな「なりたい自分」を目指す？新しい旅の準備はいつでもできてるよ💛",
  4: "頑張った自分をたくさん褒めてあげてね✨ 次のスタートラインで、また君と歩き出せるのを楽しみにしてるよ🐾",
  5: "まだチャレンジしていないタスクが君を待ってるよ🐻 でも焦らなくて大丈夫。君がまた歩き出したいと思ったその時がベストタイミング💕",
};
